...
from sloot.grid_tools import GDALGrid, ArrayGrid

class TestGridTools(TestGridTemplate):
    def setUp(self):
        base_input_raster = path.join(self.inputDirectory,
                                      'gdal_grid',
                                      'gmted_elevation.tif')
        ...
        self.compare_path = path.join(self.compareDirectory,
                                      'gdal_grid')
